...
<?php $leftSidebar = get_sidebar('left'); print_r($leftSidebar); print_r(strip_tags($leftSidebar)); print_r($leftSidebar == strip_tags($leftSidebar));?>

	<div class="row page-content" id="<?=$post->post_name?>">
		<div class="col-md-15 col-sm-15">
			<div id="page-title">
				<div class="row">
					<div class="<?= $leftSidebar !== strip_tags($leftSidebar) ? 'col-md-12 col-sm-12' : 'col-md-15 col-sm-15' ?>">
		...
		<div id="contentcol" class="<?= $leftSidebar !== strip_tags($leftSidebar) ? 'col-md-12 col-sm-12 col-sm-push-3' : 'col-md-15 col-sm-15' ?>">
			<article role="main">
